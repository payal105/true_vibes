...
<!--===== HERO AREA STARTS =======-->
            ...
            <div class="img1">
              <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
                <path
                  ...
                  stroke="#33A1E0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            </div>
            <div class="content">
              <p>Our Email</p>
  ...
  <circle cx="16" cy="16" r="13.333" stroke="#33A1E0" stroke-width="2.5" />

  <!-- Inner location pin -->
  <path
    d="M16 9C13.7909 9 12 10.7909 12 13C12 16.5 16 22 16 22C16 22 20 16.5 20 13C20 10.7909 18.2091 9 16 9ZM16 14.6667C15.0796 14.6667 14.3333 13.9204 14.3333 13C14.3333 12.0796 15.0796 11.3333 16 11.3333C16.9204 11.3333 17.6667 12.0796 17.6667 13C17.6667 13.9204 16.9204 14.6667 16 14.6667Z"
    fill="#33A1E0"
  />
</svg>
